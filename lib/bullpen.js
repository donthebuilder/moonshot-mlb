...
export function penLineParts(pen, opts = {}) {
  ...
  // #62: this sentence sits under "Behind him:" on a card whose header already
  // carries the STARTER's WHIP, and read as a bare "1.32 WHIP" -- a third
  // number on the same card with nothing marking it as the bullpen's.
  if (pen.whip != null) rates.push(`a ${pen.whip.toFixed(2)} WHIP as a pen`)
