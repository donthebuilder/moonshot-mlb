...
//   signal      4.55:1           Δ24           0.012 → 0.083 fill, 0.301 → 0.560 ink
...
//   signal   .69 ↗ .85 ↘ .68   arch, peaks middle  a sweep you can rank
...
// the colour out and each is still correctly ordered dark → light. Hue is the fast read, lightness is the
...
export const RAMPS = {
  ...
  traffic: {
    ...
    //
    //   @lum .012 .022 .033 .043 .054 .064 .076 .083   rising
    //   @sat .69 .75 .81 .85 .85 .81 .76 .68             arch
    //   @hue 0 11 22 31 41 59 101 142                     his four anchors
    //
    // and inks:
    //
    //   @ilum .301 .335 .375 .411 .449 .485 .522 .560   rising
    //   @isat .70 .80 .89 .95 .94 .89 .81 .70             arch
    //   @ihue 0 10 22 31 40 60 101 142                     same path
    //
    // The ink at each end lands within a few units of the colours he pointed
    // at: #e67272 against his #f87171, #4ddf83 against his #4ade80.
    stops: ['#3b0b0b', '#4d170b', '#562509', '#583107', '#573d07', '#4b4a08', '#25590c', '#125e2e'],
    inks: ['#e67272', '#ee7c64', '#f5884b', '#f99326', '#f1a307', '#c0bf0b', '#56da17', '#4ddf83'],
  },
