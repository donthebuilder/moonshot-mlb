...
//   VERDICT  the same idea pushed to the extremes — neon red for avoid, neon
//            green for play. Says WHICH TIER and little else.
//
...
export const RAMPS = {
  ...
  verdict: {
    id: 'verdict',
    label: 'Verdict',
    blurb: 'Avoid / okay / play. Neon red to neon green.',
    hint: 'Three hard tiers, pushed to the extremes. Fastest to skim, least detail.',
    // ── THE ONE THAT CAME BACK, RENAMED (2026-08-09) ────────────────────
    // I removed this yesterday reading "don't put PropFinder on the site" as
    // "drop the palette". He meant the NAME: "no I wanted the propfinder on
    // there, I just didn't want the name showing." So the scale returns as
    // Verdict, which is what it actually does — it delivers one, where Signal
    // gives you a gradient.
    //
    // Pushed harder than before, per "bright neon green and dark green for
    // good, deep red and neon red for bad or avoid": the fills go deeper
    // (0.014 at the floor) and the inks go fully saturated, so the extremes
    // shout and the middle stays quiet.
    stops: ['#47010f', '#5c0d07', '#602a14', '#613804', '#5c4508', '#58500e', '#056512', '#076d2c', '#047648'],
    ink:   ['#ff4a6e', '#ff6e63', '#ff8d5c', '#ffa229', '#f7b500', '#e3cc00', '#00fa21', '#59ff96', '#baffe3'],
    edge:  ['#700319', '#8b0d04', '#9a3104', '#8e5204', '#866303', '#7f7203', '#048e16', '#049a3b', '#04a766'],
  },
}
