...
export const PARK_PROPS = {
  ...
  'Chase Field': [
    ...
    { kind: 'videoboard', a: -6, off: 90, y: 62, w: 120, h: 46, text: 'Chase Field' },
  ],
  'Dodger Stadium': [
  ...
  'Petco Park': [
    { kind: 'building', a: -45, off: 8, w: 70, d: 60, h: 80, color: 0x8a4b36, windows: true }, // Western Metal Supply
    { kind: 'sign', a: -45, off: 8, y: 88, w: 96, h: 10, text: 'WESTERN METAL SUPPLY CO.', color: 0xf4f4f5 },
    { kind: 'videoboard', a: -28, off: 96, y: 64, w: 100, h: 42, text: 'Petco Park' },
    { kind: 'skyline', from: -10, to: 40, off: 600, n: 9, h: 240, color: 0x2b3340 },
  ],
  'Comerica Park': [
    { kind: 'fountains', from: -8, to: 8, off: 30, n: 7, h: 34 },                       // the liquid fireworks
    { kind: 'videoboard', a: -26, off: 96, y: 70, w: 120, h: 50, text: 'Comerica Park' },
    { kind: 'skyline', from: -30, to: 30, off: 640, n: 9, h: 260, color: 0x2b3340 },
  ],
  'Citizens Bank Park': [
