...
export const PARK_BOWLS = {
  ...
  'Petco Park':                     B({ up: [[-72, -30], [36, 72]], open: [[-7, 10]], seat: 0x1c2f5e, fascia: 0xcfc4ac }),
  ...
  'Comerica Park':                  B({ up: [[-72, -38], [38, 72]], open: [], seat: 0x1f4d33, fascia: 0x6e3a2c }),
  ...
  'Chase Field':                    B({ up: [[-72, -30], [30, 72]], roof: 'retract', open: [], seat: 0x27553a, fascia: 0x6f665a }),
