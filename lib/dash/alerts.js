...
export const PRESETS = [
  {
    key: 'essentials', label: 'Essentials', detail: 'The pregame four, homers, slam chances and touchdowns. About 4-6 a night.',
    on: ['homer', 'slam', 'nfltd', 'nflred', 'boardup', 'lastcall', 'gameoff', 'scratched',
         'frdraft', 'frclock', 'frauto', 'frlineup', 'frbye'],
  },
  {
