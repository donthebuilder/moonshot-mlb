...
//
// WHAT THIS CANNOT DO, said here so it isn't discovered: with the site fully
// CLOSED, nothing arrives. That needs Web Push — VAPID keys, a stored
// subscription per device, and a server deciding what to send. This site
// publishes nothing and stores nothing of the sort by design. The bot's
// Discord rooms already deliver with everything closed; that stays the channel
// for anything that genuinely has to reach a pocket. The panel says so.
