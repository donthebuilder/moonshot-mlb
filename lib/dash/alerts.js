...
export const CATEGORIES = [
  ...
  { key: 'callup', sport: 'mlb', group: 'Moonshot', scope: 'personal', priority: 1, push: true, live: false,
    label: 'Call-up', detail: 'First time he has ever made a posted lineup', kinds: [] },
...
export const PRESETS = [
  {
    // 2026-09-06: nflkick, multihit, callup and dropout joined the on-by-
    // default set this pass (Alert Box Score) -- kept in sync with pushRules.js's
    // own DEFAULTS, which is what a saved-settings-less account actually gets.
    key: 'essentials', label: 'Essentials', detail: 'The pregame four, homers, multi-hit nights, slam chances, kickoffs and touchdowns. About 6-8 a night.',
