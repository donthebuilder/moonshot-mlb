  ...
  return frame([
      ...
      <div key="id" style={{ display: 'flex', alignItems: 'flex-end', padding: '22px 268px 0 40px', gap: 22 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, paddingBottom: 10 }}>
          {team ? <span style={{ border: `1px solid ${ORANGE}`, color: ORANGE, fontSize: 15, fontWeight: 800, letterSpacing: 1.4, borderRadius: 999, padding: '4px 14px' }}>{team}</span> : null}
          <span style={{ fontSize: 20, color: '#b9b2a8' }}>{where}</span>
        </div>
      </div>,
