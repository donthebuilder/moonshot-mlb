    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', alignItems: 'center', padding: '24px 40px 0 40px', gap: 14 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <span style={{ fontSize: 10.5, letterSpacing: 2.6, color: DIM }}>HOME RUN TRACKER</span>
        </div>
        ...
        <div style={{ display: 'flex', marginLeft: 'auto', alignItems: 'center', gap: 12 }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            ...
            <span style={{ fontSize: 10, letterSpacing: 2, color: DIM }}>PUBLIC BOARD</span>
          </div>
          {pills.map((p) => (
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', marginTop: 'auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', padding: '12px 40px', borderTop: `1px solid ${RULE}` }}>
        ...
        <span style={{ marginLeft: 'auto', fontSize: 11.5, letterSpacing: 1.4, color: DIM }}>{note || `${site}/called`}</span>
      </div>
...
export async function homerCard(row, { site = 'dashnetwork.vercel.app' } = {}) {
  ...
  return frame([
      ...
      <div key="emblem" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'absolute', right: 40, top: 92, width: 208, padding: '16px 12px 14px 12px', borderRadius: 4, border: `1px solid ${called ? 'rgba(249,115,22,0.55)' : 'rgba(255,255,255,0.14)'}`, background: called ? 'rgba(249,115,22,0.09)' : 'rgba(255,255,255,0.04)' }}>
      ...
      // the call
      <div key="call" style={{ display: 'flex', alignItems: 'center', gap: 22, margin: '16px 268px 0 40px', padding: '13px 20px', borderRadius: 4, background: called ? 'linear-gradient(90deg, rgba(249,115,22,0.20) 0%, rgba(249,115,22,0.05) 100%)' : 'rgba(255,255,255,0.05)', border: `1px solid ${called ? 'rgba(249,115,22,0.55)' : 'rgba(255,255,255,0.10)'}` }}>
