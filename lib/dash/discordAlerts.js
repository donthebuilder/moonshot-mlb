...
// actually being played -- on deck, clutch, at the plate, bases loaded, a
// lead swinging, extra bases, a cold streak, the final score -- as opposed to
// the pregame four (boardup/lastcall/lineup/gameoff/scratched), a one-time
// roster event (callup/dropout), or next-day housekeeping (finalline, slate).
// These go to DISCORD_LIVE_WEBHOOKS when it's set (see the CONFIG comment
// above); everything else keeps using the sport-wide list it always has.
const LIVE_CATEGORIES = new Set([
  'ondeck', 'clutch', 'atbat', 'slam', 'leadchg', 'xbh', 'bigbases', 'hrr', 'cold', 'gamefinal',
])
