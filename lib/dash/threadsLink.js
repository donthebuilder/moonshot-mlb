...
// WHERE EACH POST SENDS. 2026-09-22: /start, not /called. /called is the
// record and answers "did they call it"; /start is the door — both sports, the
// graded record, and somewhere to go next — and it is the page the funnel
// measurement asked for. The proof page is one tap further in.
//
// (Superseded note, kept because the reasoning still holds for /start:)
// /called is the public proof page -- every home run
...
const MLB_PATH = '/start'
const NFL_PATH = '/start?sport=nfl'
