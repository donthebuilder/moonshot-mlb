...
//   CALLED         wore TOP or HR that night — the model's actual top call.
//   ON THE BOARD   tracked by the sheet (a graded slot exists) with no
//                  TOP/HR badge — WATCH, HIT, HRR, CONTACT, TOP15, or no
//                  role published at all.
...
// (`badged` / `onSheet` / neither) — reused here, not reinvented, so a
// hitter's status can never read differently on the two pages.
//
