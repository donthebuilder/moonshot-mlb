...
export const FRANCHISE_NAV = {
  ...
  // Its own stop (2026-09-24): "somewhere you can look up players and see who's doing what."
  players:  { path: '/league?view=players', icon: '⌕', label: 'Players', blurb: 'Look anyone up: his game log, opponents, and who owns him.' },
  feed:     { path: '/feed',     icon: '◎', label: 'Feed',       blurb: 'League chat and every transaction as it happens.' },
  // ?board=1: the bare league URL redirects to My Team once the draft is done.
  draft:    { path: '?board=1',  icon: '◈', label: 'Draft Board', blurb: 'The board, pick by pick, and who took whom.' },
...
export const FRANCHISE_MORE = ['players', 'coach', 'trades', 'feed', 'draft']

/** Desktop rail order — every stop, one row, unchanged in spirit. */
export const FRANCHISE_RAIL = ['draft', 'team', 'matchup', 'league', 'players', 'wire', 'trades', 'feed', 'coach']
