...
export const NHL_NAV = {
  ...
  board:     { label: 'Board',     icon: '\u{1F3AF}', blurb: 'Tonight\u2019s goal board \u2014 three called per game, locked before puck drop' },
  results:   { label: 'The record', icon: '\u{1F9FE}', blurb: 'Every graded night \u2014 who scored, and whether the board had him' },
  ...
  fullboard: { label: 'The Board', icon: '\u{1F4CB}', blurb: 'Every skater the model rated tonight, #1 to the bottom, every number' },
