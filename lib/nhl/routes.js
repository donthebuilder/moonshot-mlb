...
export const NHL_NAV = {
  // the rail
  scores:    { label: 'Scores', search: 'NHL scores',    icon: '\u{1F4E1}', blurb: 'Every game tonight — score, period, clock, shots, who scored' },
  ...
  board:     { label: 'Board', search: 'NHL goal board',     icon: '\u{1F3AF}', blurb: 'Tonight\u2019s goal board \u2014 three called per game, locked before puck drop' },
  ...
  fullboard: { label: 'The Board', search: 'NHL goal predictions, every skater', icon: '\u{1F4CB}', blurb: 'Every skater the model rated tonight, #1 to the bottom, every number' },
...
export const NHL_ALIASES = {
  ...
  record: 'results',      // the drawer's word on the other two
