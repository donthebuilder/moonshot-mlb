...
export function scoreFor(p, type = 'hr') {
  ...
  //
  //   1. THE BOT ALREADY DOES IT. build_game_pick_role_map() in
  //      bots/mlb_dashboard.py ranks on
  //          100 × season_iso + 10 × last5_hr + 0.35 × hr_score
  //      — ISO-led, by design, from the same audit. So the site was applying
  //      an ISO adjustment on top of a score that had already been shaped by
  //      ISO: the same signal counted twice, once explicitly and once inside
  //      the number it was multiplying.
  //
