...
export const NFL_GLOSSARY = {
  ...
  // ── the board's own columns (2026-09-25, Research = The Board) ────────
  'rz opp': 'Red-zone opportunity, as a 0-100 rank within this week\u2019s slate: how often he gets the ball inside the 20 compared with everyone else scored.',
  'gl opp': 'Goal-line opportunity, 0-100 within the slate: carries inside the 5 and targets inside the 10, the touches that score.',
  'touches': 'Carries plus targets per game, 0-100 within the slate. The single strongest thing behind a touchdown is simply getting the ball.',
  'xtd opp': 'Expected touchdowns from where his chances happen on the field, 0-100 within the slate.',
  'thin': 'Low sample: the model scored him off too few games this season. Read the number, but read it lightly.',
  'a+': 'The high-confidence flag: a TD score of 78 or better, the top band on the board.',
  'q': 'Listed as questionable on the injury report. A Q who does not play voids the pick.',
  'matchup': 'The coverage read against the defense he faces this week: TARGET when it leaks to his role, AVOID when it does not, blank when there is no strong read.',
