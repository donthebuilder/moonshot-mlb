...
// 2026-09-13: a browser-shaped User-Agent + Accept. Bare server fetches from
// cloud IPs are the usual reason ESPN's site API answers a 403 that a laptop
// never sees, and until today a refused scoreboard here was indistinguishable
// from "no games" (see pull() below) -- no TD post, no red-zone push, and no
// NFL push event has ever been written from production.
const ESPN_HEADERS = {
