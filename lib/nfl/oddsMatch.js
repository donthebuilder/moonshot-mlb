// 2026-09-13: NO 'use client'. This file is pure constants + string/math
// helpers (normName, quoteFor, edgeOf...) with no hooks, JSX or browser APIs.
// The stray directive turned every export into a client reference, so a
// server route (liveSlate.js's parseBox -> normName, in the NFL tick) threw
// "normName is on the client" and every live box score silently failed --
// the same class of bug the storylines.js directive caused. The client
// components that import this each carry their own 'use client'.
