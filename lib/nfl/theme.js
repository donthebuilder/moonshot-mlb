...
export const C = {
  ...
  turf1: '#08160f',    // the far end, toward the end zone
  turf2: '#050a08',    // at the line, where the page background takes over
     // primary — spectral jade, was #00e0a4
  cyan: '#35cdff',      // secondary — electric signal-blue, was #2dc8ff
  lime: '#a3e635',
  yellow: '#facc15',
  red: '#f87171',
  purple: '#a78bfa',
...
export const RAMP = [C.amber, '#d4dc3f', '#95e04c', '#4fe084', '#1aeaad', C.green]
...
export const MARKETS = [
  ...
  ['DEF_TD',   'Defense/ST TD',    '1+ def or return TD · v1'],
]
...
// TYPE (2026-09-25): the shared type scale. TUDDY's Streaks tab imported
// TYPE from this file, which never exported it, and the whole tab threw
// "TYPE is not defined" on the live site. One scale for both products --
// re-exported from lib/theme.js, not retyped (STATUS open item 30).
export { TYPE } from '../theme'
