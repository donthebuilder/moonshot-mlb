...
export const TABS = [
  ...
  ['pairs', 'Pairs'],
  // Live (2026-08-24) — real-time score/quarter/clock for whatever's
  // state==='in' right now, straight off the same ESPN scoreboard fetch the
  // rest of the site already reads. One focused scoreboard, not MLB's six-
  // component live layer — see components/nfl/tabs/Live.js's header for the
  // exact fields available (and the ones that aren't, like possession).
  ['live', 'Live'],
  ['guide',    'Guide'],
]
