...
export const MLB_NAV = {
  ...
  gap:        { label: 'Gap board',    icon: '\u25C7', blurb: 'Doubles and triples \u2014 measured, no score' },
...
export const NFL_NAV = {
  ...
  live:           { label: 'Live',           icon: '\u25CF', blurb: 'Every rung on the card against its bar, while the game is on' },
...
export const NFL_MORE_GROUPS = [
  ['Sunday',   ['live']],
  ['Research', ['matchups', 'pairs', 'streaks']],
