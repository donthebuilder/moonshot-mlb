...
export const BRAND = {
  mlb: { name: 'MOONSHOT', league: 'MLB' },
  nfl: { name: 'TUDDY', league: 'NFL' },
  nhl: { name: 'LAMP', league: 'NHL' },
}
...
export const SPORT_KEYS = Object.keys(TABLE)
...
export const MLB_NAV = {
  ...
  fullboard:  { label: 'The Board', search: 'Home run predictions, every hitter',    icon: '\u{1F4CB}', blurb: 'Every hitter the model rated tonight, #1 to the bottom, every stat' },
...
export const NFL_NAV = {
  ...
  touchdowns:     { label: 'Props', search: 'Anytime touchdown picks',          icon: '\u{1F0CF}', blurb: 'Who scores this week, and why' },
  boards:         { label: 'Boards',         icon: '\u{1F4CA}', blurb: 'Ranked boards across the seven markets' },
  games:          { label: 'Slate', search: 'NFL games this week',          icon: '\u{1F4CB}', blurb: "Every game, its script, and the model's read on it" },
  picks:          { label: 'Picks',          icon: '\u{1F3AF}', blurb: 'What the model says to back this week' },
  research:       { label: 'The Board',      icon: '\u{1F4CB}', blurb: 'Every scored player, #1 to the bottom, every number' },
  ...
  // the drawer
  players:        { label: 'Player portal', search: 'NFL players',  icon: '\u{1F464}', blurb: 'Every player, the full file' },
...
const NAMES = { mlb: MLB_NAMES, nfl: NFL_NAMES, nhl: NHL_NAMES }
...
const NAVS = { mlb: MLB_NAV, nfl: NFL_NAV, nhl: NHL_NAV }
