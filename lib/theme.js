...
// ── COMBINED TABS (2026-08-15, round two) ────────────────────────────────────
//
// The dropdown nav shipped and Donovan killed it on sight: "you downsized
// everything but didn't keep the info, i seen nothing — revert it back and
// combine a few tabs." He was righter than he knew — the render audit found
// the dropdown was being CLIPPED INVISIBLE by the header's own scroll rail,
// and two of the four fold pills were dead. So: the flat row is back, and the
// condensing is done the way he actually asked — four pages folded into their
// hosts as view pills, their keys gone from this row but still rendering
// standalone for every old deep link:
//
//   boxes → Games · runs (Patterns) → Boards · pairhist → Pairs
//   trueprice → Results
export const TABS = [
  ...
  ['bot',         'Picks'],
  // 💵 every book price on the slate, with the LINE the book actually set
  // (2026-08-15, Donovan: "maybe like a page to see all the odds").
  ['odds',        'Odds'],
