...
export const THEMES = {
  ...
  light: {
    ...
    C: {
      ...
      scrim: 'rgba(255,255,255,.97)', shadow: 'rgba(15,23,42,.16)',
    },
    accent: '#c2410c',
  ...
  ember: {
    ...
    C: {
      ...
      scrim: 'rgba(9,9,11,.96)', shadow: 'rgba(0,0,0,.5)',
    },
    accent: '#f97316',
  ...
  mono: {
    ...
    C: {
      ...
      scrim: 'rgba(10,10,10,.96)', shadow: 'rgba(0,0,0,.5)',
    },
    accent: '#e8a33d',
  ...
  steel: {
    ...
    C: {
      ...
      scrim: 'rgba(8,11,16,.96)', shadow: 'rgba(0,0,0,.5)',
    },
    accent: '#5aa6f0',
  ...
  regal: {
    ...
    C: {
      ...
      scrim: 'rgba(10,9,19,.96)', shadow: 'rgba(0,0,0,.5)',
    },
    accent: '#d4af6a',
