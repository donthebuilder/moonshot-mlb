      ...
      <style jsx>{`
        ...
        @media (max-width: 760px) {
          .fxBar {
            ...
            border: 1px solid var(--fx-line-2, #34333f); border-radius: 17px;
            background: color-mix(in srgb, var(--fx-panel-2, #17161c) 92%, transparent);
          ...
          .fxSheet {
            ...
            border: 1px solid var(--fx-line-2, #34333f); border-radius: 17px;
            background: var(--fx-panel-2, #17161c); box-shadow: 0 25px 80px #000d;
          ...
          .fxSheetHead small { display: block; color: #ff633e; font: 900 8px/1 monospace; letter-spacing: .14em }
          .fxSheetHead strong { display: block; margin-top: 3px; font-size: 18px; color: #efeae2 }
          .fxSheetHead button { width: 32px; height: 32px; border: 1px solid var(--fx-line, #2a2933); border-radius: 9px; background: var(--fx-bg, #0f0e13); color: #c9c4bd; font-size: 20px; cursor: pointer }
          ...
          .fxSheetGrid :global(a) {
            ...
            border: 1px solid var(--fx-line, #2a2933); border-radius: 10px;
            background: var(--fx-bg, #0f0e13); color: #c9c4bd; text-decoration: none;
          }
          .fxSheetGrid :global(a.active) { border-color: #ff633e70; background: #ff633e14 }
          .fxSheetGrid :global(a span) { display: block; font-size: 11px; font-weight: 900 }
          .fxSheetGrid :global(a small) { display: block; margin-top: 4px; color: #8b8792; font-size: 8px; line-height: 1.25 }
        }
      `}</style>
    </>
  )
