  ...
  return <main className={styles.roomApp}>
    ...
    <div className={styles.roomBody}>
      ...
      <div className={styles.wireLayout}>
        <section className={styles.playerBoard}><div className={styles.boardHead}><div><p className={styles.panelLabel}>AVAILABLE PLAYERS</p><h2>Free agents & waivers</h2></div><form className={styles.playerSearch}><input aria-label="Search players" name="q" defaultValue={query?.q||''} placeholder="Search player or team"/><input type="hidden" name="position" value={selectedPosition}/><button>Search</button></form><span>{availablePlayers.length} players</span></div>
