...
export default function TeamPower({ players = [], statSeason, onPlayerClick }) {
  ...
  return (
    <section className="tuddy-team-power">
      ...
      <style>{`
        .tuddy-team-power{border:1px solid rgba(0,245,173,.22);border-radius:16px;padding:14px 14px 10px;background:linear-gradient(160deg,rgba(0,245,173,.06),transparent 60%)}
        ...
        .tp-bar>span{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,${RAMP[0]},${RAMP[2]},${RAMP[5]})}
        ...
        .tp-more{margin-top:8px;padding:5px 12px;border-radius:999px;border:1px solid rgba(0,245,173,.4);background:transparent;color:inherit;font:800 10px/1 var(--num-font,ui-monospace,monospace);cursor:pointer}
