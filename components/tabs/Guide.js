...
export default function Guide({ onNavigate }) {
  return (
    <div style={{ maxWidth: 760, margin: '0 auto' }}>
      ...
      {/* ── WHAT ACTUALLY PREDICTS A HOME RUN (2026-09-06) ──────────────────
             Added after the homer-night audit and the follow-up passes that
             settled distance, doubles, RBI, runs and batting average. Every
             number here is measured on 38,432 hitter-nights across 157 nights
             of the 2026 regular season, with both data sources leak-checked
             first. Collapsed by default: it is reference, not the path.

             It lives in the Guide because the site's boards already rank on
             Power-3 and people ask why the obvious stuff (hot streak, batting
             average, "he's due") isn't on them. This is the answer, with the
             receipts. ── */}
      <Section title="What actually predicts a home run" emoji="🎯">
        ...
        <P><b style={{ color: C.text }}>Tested, and they don&apos;t work</b></P>
        <Stat stat="Batting avg" def="a coin flip, and slightly backwards. Over .300 homers no more than under .150" />
        <Stat stat="Recent hits" def="nothing, at 5 or 10 games" />
        <Stat stat="Doubles" def="nothing. A double is a home run that didn't happen, not a sign one is coming" />
        ...
        <Note>
          <b style={{ color: C.text }}>The trap, and it has caught this project four times.</b> Any
          stat counting what a hitter just <i>did</i> — homers, extra-base hits, a hot streak —
          looks incredible in a saved file and is worthless live, because the file is written
          <i> after</i> the game and tonight is already inside &quot;last 5&quot;. Every one of them
          collapsed or reversed once measured with an honest cutoff.
        </Note>

        <P>
          There is also no run-up and no carry-over. A hitter&apos;s numbers in the three games
          before a home run look like any other night, and his home run rate in the five games
          after one is slightly <i>lower</i> than after a blank.{' '}
          <b style={{ color: C.text }}>Hot and cold aren&apos;t real here. Talent is.</b>
        </P>
      </Section>
